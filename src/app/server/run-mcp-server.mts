/**
 * @file src/app/server/run-mcp-server.mts
...
import {type LogLevel, logger} from "@app/runtime/app-logger";
import {capture} from "@app/runtime/output-capture";
import {FilteredStdioServerTransport} from "@app/transport/stdio-transport";
import {flushDeferredMessages, server} from "@app/server/create-mcp-server";
