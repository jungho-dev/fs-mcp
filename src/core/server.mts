...
import { getSystemInfo, getOSSpecificGuidance, getPathGuidance, getDevelopmentToolGuidance } from '../utils/system-info.mjs';
...
import { getConfig, setConfigValue } from '../tools/config.mjs';
import { toolHistory } from '../utils/toolHistory.mjs';

import { VERSION } from './version.mjs';
import { capture } from "../utils/capture.mjs";
import { logToStderr, logger } from '../utils/logger.mjs';
...
server.setRequestHandler(CallToolRequestSchema, async (request: CallToolRequest): Promise<ServerResult> => {
    ...
    try {
        ...
        if (metadata && typeof metadata === 'object' && metadata.clientInfo) {
