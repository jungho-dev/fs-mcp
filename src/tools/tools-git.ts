...
const GIT_TOOL_DESCRIPTIONS: GitToolDescription[] = [
  ...
  { name: "git_commit", title: "Git Commit", description: ["Create a commit from staged changes.", CMD_PREFIX_DESCRIPTION].join("\n"), readOnlyHint: false, destructiveHint: true },
  ...
  { name: "git_merge", title: "Git Merge", description: ["Merge a branch into the current branch.", CMD_PREFIX_DESCRIPTION].join("\n"), readOnlyHint: false, destructiveHint: true },
  ...
  { name: "git_stash", title: "Git Stash", description: ["List, save, apply, pop, or drop stashes.", CMD_PREFIX_DESCRIPTION].join("\n"), readOnlyHint: false, destructiveHint: true },
  { name: "git_status", title: "Git Status", description: ["Show working tree status, staging, and conflicts.", CMD_PREFIX_DESCRIPTION].join("\n"), readOnlyHint: true },
  { name: "git_tag", title: "Git Tag", description: ["List, create, delete, or verify tags.", CMD_PREFIX_DESCRIPTION].join("\n"), readOnlyHint: false, destructiveHint: true },
...
export const GIT_TOOL_CATALOG: ToolCatalogEntry[] = GIT_TOOL_DESCRIPTIONS.map((tool) => ({
  ...
  inputSchema: zodToJsonSchema(GIT_INPUT_SCHEMAS[tool.name]),
  annotations: {
    title: tool.title,
