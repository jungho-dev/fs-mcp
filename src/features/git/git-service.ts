...
import {runGitBlame, runGitChangelogAnalyze, runGitReflog, runGitWrapupInstructions} from "@features/git/git-operations-history";
import {runGitFetch, runGitPull, runGitPush, runGitRemote} from "@features/git/git-operations-remotes";
import {runGitClearWorkingDir, runGitClone, runGitInit, runGitSetWorkingDir, runGitStatus} from "@features/git/git-operations-repository";
import {runGitAdd, runGitCommit, runGitDiff, runGitLog, runGitShow} from "@features/git/git-operations-working-tree";
...
const GIT_TOOL_HANDLERS = {
  ...
  "git_clear_working_dir": runGitClearWorkingDir,
  ...
  "git_wrapup_instructions": runGitWrapupInstructions,
