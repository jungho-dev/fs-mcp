/**
 * @file src/features/process/terminal-service.mts
...
import { analyzeProcessState } from "@features/process/repl-detector";
import type { ActiveSession, CommandExecutionResult, OutputEvent, TerminalSession, TimingInfo } from "@type/common-types";
