/**
 * @file src/features/filesystem/readers/text-reader.mts
 ...
 *
 * Binary detection is handled at the factory level (reader-factory.mts) using isBinaryFile.
...
import type { FileHandler, FileInfo, FileResult, ReadOptions } from "@features/filesystem/readers/base";
...
export class TextFileHandler implements FileHandler {
  ...
  // ========================================================================
  // Private Helper Methods (extracted from filesystem-service.mts)
  // ========================================================================
   ...
   * Made static and public for use by other modules (e.g., readFileInternal in filesystem-service.mts)
   */
