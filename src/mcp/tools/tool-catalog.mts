/**
 * @file src/mcp/tools/tool-catalog.mts
...
import {EDIT_TOOL_CATALOG} from "@mcp/tools/catalog/edit-tools";
...
export function createToolCatalog(): ToolCatalogEntry[] {
  return [...CONFIG_TOOL_CATALOG, ...FILESYSTEM_TOOL_CATALOG, ...EDIT_TOOL_CATALOG, ...PROCESS_TOOL_CATALOG];
}
