/**
 * @file src/mcp/controllers/batch-tool-support.ts
...
export async function runParallelBatch<T>(
  items: T[],
  runItem: (item: T) => Promise<ServerResult>,
): Promise<BatchToolItemResult<T>[]> {
