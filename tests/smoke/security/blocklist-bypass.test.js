...
async function runTests() {
  ...
  try {
    ...
    const cmds7 = cmdMgr2.extractCommands('echo "`/usr/bin/sudo`"');
    ...
    const cmds8 = cmdMgr2.extractCommands("$MYVAR ls");
