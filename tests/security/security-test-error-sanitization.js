...
// This mirrors the implementation in src/platform/runtime/runtime-output-capture.ts but avoids import issues
// when running tests. The actual sanitization logic is identical.
//
// NOTE: If you update the sanitizeError function in src/platform/runtime/runtime-output-capture.ts,
...
const runAllTests = async () => {
  ...
  allPassed =
    runTest("sanitizeError - Error object with path", () => {
  ...
  allPassed =
    runTest("sanitizeError - Windows path", () => {
  ...
  allPassed =
    runTest("sanitizeError - Multiple paths", () => {
  ...
  allPassed =
    runTest("sanitizeError - String error", () => {
  ...
  allPassed =
    runTest("sanitizeError - Error code preservation", () => {
  ...
  allPassed =
    runTest("sanitizeError - Path with special characters", () => {
  ...
  allPassed =
    runTest("sanitizeError - Non-error input", () => {
  ...
  allPassed =
    runTest("sanitizeError - Actual system paths", () => {
  ...
  allPassed =
    runTest("Integration - capture with error object", () => {
      // Create a mock capture function to test integration
      const mockCapture = (_event, properties) => {
        // Check that no file paths are in the properties
        const stringified = JSON.stringify(properties);
        const containsPaths = /(?:\/|\\)[\w\d_.-/\\]+/.test(stringified) || /[A-Za-z]:\\[\w\d_.-/\\]+/.test(stringified);
