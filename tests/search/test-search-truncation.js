...
const SEARCH_FIXTURE_PATH = path.join(SEARCH_FIXTURE_DIR, "file-with-1500-lines.txt");
...
async function testSearchTruncation() {
  try {
    ...
    if (combinedLength > apiLimit && !finalResult.content[0].text.includes("Results truncated")) {
