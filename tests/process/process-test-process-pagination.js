...
import { interactWithProcess, readProcessOutput, startProcess } from "../../out/features/process/process-runner.mjs";
...
async function testNewOutputBehavior() {
  ...
  const _lines1 = (read1.content[0].text.match(/tick\d/g) || []).length;
